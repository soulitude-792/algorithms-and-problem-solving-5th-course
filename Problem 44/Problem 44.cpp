...
int  PositiveNumberCountInArray(int arr[100], int arrlen)
{
...
int main()
{
	...
	std::cout << "Positive number count is: " << PositiveNumberCountInArray(arr, length) << '\n';
	
	return 0;
}

/*the purpose of the program is to fill the array with random numbers and then count only the Positive 
...
called PositiveNumberCountInArray. then it checks every element if it's Postive or Negative, if it's positive
